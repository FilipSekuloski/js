...
let navigationService = {
    // currentPage:1,
    personBtn:document.getElementById("person"),
    spaceShipBtn:document.getElementById("ship"),
...
let apiService = {
    ...
    getPeople: function(page) {
        ...
        .then(function(response) {
          ...
          uiService.checkPrevNext(data.previous, data.next);// check if there is a next page
            // loader
            uiService.renderPeople(data.results);// show results
            console.log(data);
